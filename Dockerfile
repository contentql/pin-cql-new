...
ARG HASURA_API_KEY
ARG RAILWAY_SUPER_API
ARG NEXT_PUBLIC_HASURA_URI
ARG OPENAPI_KEY
ARG ENCRYPTION_KEY
...
ARG NEXT_PUBLIC_PRICING_TABLE_ID
...
ENV HASURA_API_KEY=$HASURA_API_KEY
ENV RAILWAY_SUPER_API=$RAILWAY_SUPER_API
ENV NEXT_PUBLIC_HASURA_URI=$NEXT_PUBLIC_HASURA_URI
ENV OPENAPI_KEY=$OPENAPI_KEY
ENV ENCRYPTION_KEY=$ENCRYPTION_KEY
ENV STRIPE_SECRET_KEY=$STRIPE_SECRET_KEY
ENV STRIPE_PUBLISHABLE_KEY=$STRIPE_PUBLISHABLE_KEY
ENV SUBSCRIPTION_PLAN=$SUBSCRIPTION_PLAN
ENV API_VERCEL_KEY=$API_VERCEL_KEY
ENV NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY=$NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY
ENV NEXT_PUBLIC_PRICING_TABLE_ID=$NEXT_PUBLIC_PRICING_TABLE_ID
