        ...
        <div className='mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3'>
            ...
            <div className='flex h-[180px] flex-col justify-between rounded-md p-6'>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-muted-foreground text-sm'>
                  Write with ease using our intuitive rich text editor. Format
                  your posts and other media.
                </p>
              </div>
            </div>
          </div>
          <div className='bg-background relative overflow-hidden rounded-lg border p-2'>
            <div className='flex h-[180px] flex-col justify-between rounded-md p-6'>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-muted-foreground text-sm'>
                  Boost your blog’s search engine ranking with built-in SEO
                  tools.
                </p>
              </div>
            </div>
          ...
          <div className='bg-background relative overflow-hidden rounded-lg border p-2'>
            <div className='flex h-[180px] flex-col justify-between rounded-md p-6'>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-muted-foreground text-sm'>
                  We offer robust security measures to protect content and
          ...
          <div className='bg-background relative overflow-hidden rounded-lg border p-2'>
            <div className='flex h-[180px] flex-col justify-between rounded-md p-6'>
              ...
              <div className='space-y-2'>
                <h3 className='font-bold'>Interactive Comments</h3>
                <p className='text-sm'>
                  Encourage discussions and engage with your readers through our
          ...
          <div className='bg-background relative overflow-hidden rounded-lg border p-2'>
            <div className='flex h-[180px] flex-col justify-between rounded-md p-6'>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-muted-foreground text-sm'>
                  Expand your reach by sharing your posts on social media
